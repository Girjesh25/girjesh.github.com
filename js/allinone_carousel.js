...
(function(c) {
    ...
    function A(b, a, f, l, g, n, p, w, e) {
        f.effectIsRunning = !0;
        a.showCircleTimer && c(".mycanvas", n).css({
            display: "none"
        });
        var h, k, q, r;
        "true" == c(g[f.current_img_no]).attr("data-video") && (c("#contentHolderUnit_" + f.current_img_no, n).html(c(g[f.current_img_no]).html()), a.responsive && a.width != a.origWidth && F(c("#contentHolderUnit_" + f.current_img_no, n), 0, a, f));
        c(l[f.current_img_no]).removeClass("bottomNavButtonON");
        f.current_img_no = C(f.current_img_no, b, p);
        "true" != c(g[f.current_img_no]).attr("data-video") && w.css("display", "none");
        c(l[f.current_img_no]).addClass("bottomNavButtonON");
        f.currentZ_index = 100;
        f.currentImg = c("#contentHolderUnit_" + f.current_img_no, n);
        h = a.contentHolderUnitOrigWidth / (a.origWidth / a.width);
        k = a.contentHolderUnitOrigHeight / (a.origWidth / a.width);
        q = parseInt((a.width - a.contentHolderUnitOrigWidth / (a.origWidth / a.width)) / 2, 10);
        r = parseInt(a.height - a.contentHolderUnitOrigHeight / (a.origWidth / a.width), 10) - a.verticalAdjustment / (a.origWidth / a.width);
        D(f.currentImg, q, r, h, k, 1, !1, b, f, a, e, g, p, w, l, n);
        u = f.current_img_no;
        for (m = 1; m <= Math.floor(a.numberOfVisibleItems / 2); m++) f.currentZ_index--, u = C(u, -1, p), f.currentImg = c("#contentHolderUnit_" + u, n), f.currentImg.css("z-index", f.currentZ_index), m == Math.floor(a.numberOfVisibleItems / 2) && (1 === b ? (last_aux_img_no = C(u, -1, p), last_currentImg = c("#contentHolderUnit_" + last_aux_img_no, n), k = a.contentHolderUnitOrigHeight / (a.origWidth / a.width) - 2 * (m + 1) * a.elementsVerticalSpacing / (a.origWidth / a.width), h = parseInt(k * f.aspectOrig, 10), q = parseInt((a.width - a.contentHolderUnitOrigWidth / (a.origWidth / a.width)) / 2, 10) - (m + 1) * a.elementsHorizontalSpacing / (a.origWidth / a.width), r = parseInt(a.height - a.contentHolderUnitOrigHeight / (a.origWidth / a.width), 10) - a.verticalAdjustment / (a.origWidth / a.width) + (m + 1) * a.elementsVerticalSpacing / (a.origWidth / a.width), D(last_currentImg, q, r, h, k, 0, !1, b, f, a, e, g, p, w, l, n)) : (k = a.contentHolderUnitOrigHeight / (a.origWidth / a.width) - 2 * (m + 1) * a.elementsVerticalSpacing / (a.origWidth / a.width), parseInt(k * f.aspectOrig, 10), F(f.currentImg, m + 1, a, f), q = parseInt((a.width - a.contentHolderUnitOrigWidth / (a.origWidth / a.width)) / 2, 10) - (m + 1) * a.elementsHorizontalSpacing / (a.origWidth / a.width), r = parseInt(a.height - a.contentHolderUnitOrigHeight / (a.origWidth / a.width), 10) - a.verticalAdjustment / (a.origWidth / a.width) + (m + 1) * a.elementsVerticalSpacing / (a.origWidth / a.width), f.currentImg.css({
            ...
            top: r + "px",
            opacity: 0
        }))), f.currentImg.css("display", "block"), k = a.contentHolderUnitOrigHeight / (a.origWidth / a.width) - 2 * m * a.elementsVerticalSpacing / (a.origWidth / a.width), h = parseInt(k * f.aspectOrig, 10), q = parseInt((a.width - a.contentHolderUnitOrigWidth / (a.origWidth / a.width)) / 2, 10) - m * a.elementsHorizontalSpacing / (a.origWidth / a.width), r = parseInt(a.height - a.contentHolderUnitOrigHeight / (a.origWidth / a.width), 10) - a.verticalAdjustment / (a.origWidth / a.width) + m * a.elementsVerticalSpacing / (a.origWidth / a.width), D(f.currentImg, q, r, h, k, 1, !1, b, f, a, e, g, p, w, l, n);
        var u = f.current_img_no;
        for (m = 1; m <= Math.floor(a.numberOfVisibleItems / 2); m++) f.currentZ_index--, u = C(u, 1, p), f.currentImg = c("#contentHolderUnit_" + u, n), f.currentImg.css("z-index", f.currentZ_index), m == Math.floor(a.numberOfVisibleItems / 2) && (1 === b ? (F(f.currentImg, m + 1, a, f), f.currentImg.css({
    ...
    function D(b, a, f, l, g, n, p, w, e, h, k, q, r, u, x, s) {
        e.slideIsRunning = !0;
        k.html(c(q[e.current_img_no]).attr("data-title"));
        h.responsive && I(k, h);
        ...
        b.animate({
            ...
            if (p) {
                ...
                "true" == c(q[e.current_img_no]).attr("data-video") && u.css("display", "block");
    ...
    function J(b, a, c, l, g, n, p, w, e) {
        -1 === c.current_img_no - b ? A(1, a, c, l, g, n, p, w, e) : 1 === c.current_img_no - b ? A(-1, a, c, l, g, n, p, w, e) : (c.fastForwardRunning = !0, a.animationTime = 0.4, a.autoPlay = 0.1, c.img_no_where_to_stop = b, c.current_img_no < b ? b - c.current_img_no < p - b + c.current_img_no ? A(1, a, c, l, g, n, p, w, e) : A(-1, a, c, l, g, n, p, w, e) : c.current_img_no > b && (c.current_img_no - b < p - c.current_img_no + b ? A(-1, a, c, l, g, n, p, w, e) : A(1, a, c, l, g, n, p, w, e)))
    }

    function M(b, a, f, l, g, n, p, w, e, h, k, q, r, u, x, s, t) {
        u.css("display", "none");
        a.enableTouchScreen ? (responsiveWidth = g.parent().parent().parent().width(), responsiveHeight = g.parent().parent().parent().height()) : (responsiveWidth = g.parent().parent().width(), responsiveHeight = g.parent().parent().height());
    ...
    c.fn.allinone_carousel = function(b) {
        ...
        return this.each(function() {
            ...
            b.showBottomNav || (k.css("display", "none"), q.css("display", "none"), r.css("display", "none"));
            b.showOnInitBottomNav || (k.css("left", "-5000px"), q.css("left", "-5000px"), r.css("left", "-5000px"));
            var x = c(".elementTitle", g);
            b.showElementTitle || x.css("display", "none");
            b.elementOrigTop = parseInt(x.css("top").substr(0, x.css("top").lastIndexOf("px")), 10);
            x.css("top", parseInt(b.elementOrigTop / (b.origWidth / b.width), 10));
            var s = c(".playOver", g),
                f = K(),
                t = 0,
                d = {
            ...
            d.canvas.width = 2 * b.circleRadius + 4 * b.circleLineWidth;
            ...
            var v = a.find("ul:first").children();
            ...
            v.each(function() {
                ...
                d.currentImg.is("li") && (t++, y = c('<div class="contentHolderUnit" rel="' + (t - 1) + '" id="contentHolderUnit_' + (t - 1) + '">' + d.currentImg.html() + "</div>"), n.append(y), y.css("display", "none"), 0 === b.contentHolderUnitOrigWidth && (b.contentHolderUnitOrigWidth = y.width(), b.contentHolderUnitOrigHeight = y.height(), d.aspectOrig = b.contentHolderUnitOrigWidth / b.contentHolderUnitOrigHeight), F(y, 0, b, d), y.css({
                    left: parseInt((b.width - y.width()) / 2, 10) + "px",
                    top: parseInt(b.height - y.height(), 10) - b.verticalAdjustment / (b.origWidth / b.width) + "px"
                }), 1 == t ? (y.css({
                    left: parseInt((b.width - y.width()) / 2, 10) + "px",
                    top: parseInt(b.height - y.height(), 10) - b.verticalAdjustment / (b.origWidth / b.width) + "px",
                    "z-index": d.currentZ_index,
                    display: "block"
                }), "true" == c(v[d.current_img_no]).attr("data-video") && s.css("display", "block")) : t <= Math.ceil(b.numberOfVisibleItems / 2) && (d.currentZ_index--, F(y, t - 1, b, d), y.css({
                    left: parseInt((b.width - b.contentHolderUnitOrigWidth / (b.origWidth / b.width)) / 2, 10) + (b.contentHolderUnitOrigWidth / (b.origWidth / b.width) + (t - 1) * b.elementsHorizontalSpacing / (b.origWidth / b.width) - y.width()) + "px",
                    top: parseInt(b.height - b.contentHolderUnitOrigHeight / (b.origWidth / b.width), 10) - b.verticalAdjustment / (b.origWidth / b.width) + (t - 1) * b.elementsVerticalSpacing / (b.origWidth / b.width) + "px",
                    "z-index": d.currentZ_index,
                    display: "block"
                })), B = c('<div class="bottomNavButtonOFF" rel="' + (t - 1) + '"></div>'), k.append(B), C += parseInt(B.css("padding-left").substring(0, B.css("padding-left").length - 2), 10) + B.width(), L = parseInt((k.height() - parseInt(B.css("height").substring(0, B.css("height").length - 2))) / 2, 10), B.css("margin-top", L + "px"))
            });
            s.css({
                left: parseInt((b.width - s.width()) / 2, 10) + "px",
                top: parseInt(b.height - b.contentHolderUnitOrigHeight / (b.origWidth / b.width), 10) + parseInt((b.contentHolderUnitOrigHeight / (b.origWidth / b.width) - s.height()) / 2, 10) - parseInt(b.verticalAdjustment / (b.origWidth / b.width), 10) + "px",
                "margin-top": b.playMovieMarginTop / (b.origWidth / b.width)
            });
            b.showCircleTimer && (cLeftPos = c("#contentHolderUnit_" + d.current_img_no, g).css("left"), cTopPos = c("#contentHolderUnit_" + d.current_img_no, g).css("top"), c(".mycanvas", g).css({
            ...
            for (m = 1; m <= Math.floor(b.numberOfVisibleItems / 2); m++) d.currentZ_index--, F(c("#contentHolderUnit_" + (t - m), g), m, b, d), c("#contentHolderUnit_" + (t - m), g).css({
            ...
            x.html(c(v[0]).attr("data-title"));
            b.responsive && I(x, b);
            k.width(C);
            b.showOnInitBottomNav && (k.css("left", parseInt((g.width() - C) / 2, 10) + "px"), q.css("left", parseInt(k.css("left").substring(0, k.css("left").length - 2), 10) - q.width() + "px"), r.css("left", parseInt(k.css("left").substring(0, k.css("left").length - 2), 10) + k.width() + parseInt(B.css("padding-left").substring(0, B.css("padding-left").length - 2), 10) + "px"));
            ...
            d.current_img_no = 0;
            d.currentImg = c(v[d.current_img_no]);
            g.mouseenter(function() {
                ...
                d.effectIsRunning || (clearTimeout(d.timeoutID), nowx = (new Date).getTime(), d.timeElapsed += nowx - d.arcInitialTime, b.autoHideNavArrows && b.showNavArrows && (e.css("display", "block"), h.css("display", "block")), b.autoHideBottomNav && b.showBottomNav && (k.css({
                    display: "block",
                    left: parseInt((g.width() - C) / 2, 10) + "px"
                }), q.css({
                    display: "block",
                    left: parseInt(k.css("left").substring(0, k.css("left").length - 2), 10) - q.width() + "px"
                }), r.css({
                    display: "block",
            ...
            g.mouseleave(function() {
                d.mouseOverBanner = !1;
                if (!d.effectIsRunning && (nowx = (new Date).getTime(), b.autoHideNavArrows && b.showNavArrows && (e.css("display", "none"), h.css("display", "none")), b.autoHideBottomNav && b.showBottomNav && (k.css("display", "none"), q.css("display", "none"), r.css("display", "none")), 0 < b.autoPlay && 1 < t && !d.fastForwardRunning && !d.isVideoPlaying)) {
            ...
            y = c(".contentHolderUnit", g);
            y.click(function() {
                if (!d.slideIsRunning && !d.fastForwardRunning) {
                    var a = c(this).attr("rel");
                    a != d.current_img_no ? (d.isVideoPlaying = !1, c(z[d.current_img_no]).removeClass("bottomNavButtonON"), J(parseInt(a, 10), b, d, z, v, g, t, s, x)) : "true" == c(v[d.current_img_no]).attr("data-video") ? (s.css("display", "none"), D = c(this).find("img:first"), D.css("display", "none"), d.isVideoPlaying = !0) : void 0 == c(v[d.current_img_no]).attr("data-link") || "" == c(v[d.current_img_no]).attr("data-link") || d.effectIsRunning || E || (a = b.target, void 0 != c(v[d.current_img_no]).attr("data-target") && "" != c(v[d.current_img_no]).attr("data-target") && (a = c(v[d.current_img_no]).attr("data-target")), "_blank" == a ? window.open(c(v[d.current_img_no]).attr("data-link")) : window.location = c(v[d.current_img_no]).attr("data-link"))
                }
            });
            s.click(function() {
            ...
            e.mousedown(function() {
                E = !0;
                d.slideIsRunning || d.fastForwardRunning || (d.isVideoPlaying = !1, clearTimeout(d.timeoutID), A(-1, b, d, z, v, g, t, s, x))
            });
            e.mouseup(function() {
                E = !1
            });
            ...
            var z = c(".bottomNavButtonOFF", g);
            z.mousedown(function() {
                E = !0;
                if (!d.slideIsRunning && !d.fastForwardRunning) {
                    var a = c(this).attr("rel");
                    a != d.current_img_no && (d.isVideoPlaying = !1, c(z[d.current_img_no]).removeClass("bottomNavButtonON"), J(parseInt(a, 10), b, d, z, v, g, t, s, x))
                }
            });
            z.mouseup(function() {
                E = !1
            ...
            z.mouseenter(function() {
                var a = c(this),
                    d = a.attr("rel");
                b.showPreviewThumbs && (u = c('<div class="bottomOverThumb"></div>'), a.append(u), d = c(v[d]).attr("data-bottom-thumb"), u.html('<img src="' + d + '">'));
                a.addClass("bottomNavButtonON")
            });
            z.mouseleave(function() {
                var a = c(this),
                    e = a.attr("rel");
                b.showPreviewThumbs && u.remove();
                d.current_img_no != e && a.removeClass("bottomNavButtonON")
            });
            b.enableTouchScreen && (f = Math.floor(1E5 * Math.random()), g.wrap('<div id="carouselParent_' + f + '" style="position:relative;" />'), c("#carouselParent_" + f).width(b.width + 1), c("#carouselParent_" + f).height(b.height), g.css({
                    cursor: "url(" + b.absUrl + "css/skins/hand.cur),url(" + b.absUrl + "css/skins/hand.cur),move",
                    left: "0px",
                    position: "absolute"
                }), rightVal = parseInt(h.css("right").substring(0, h.css("right").length - 2), 10), g.mousedown(function() {
                ...
                g.draggable({
                    ...
                    stop: function(a, f) {
                        d.effectIsRunning || (finalLeft = c(this).css("left"), direction = 1, origLeft < finalLeft && (direction = -1), A(direction, b, d, z, v, g, t, s, x));
                        0 > rightVal && (h.css({
                            right: rightVal + "px",
                            visibility: "visible"
                        }), e.css("visibility", "visible"));
            ...
            c(window).resize(function() {
                var f = K();
                doResizeNow = !0; - 1 != navigator.userAgent.indexOf("Android") && (0 == b.windowOrientationScreenSize0 && 0 == window.orientation && (b.windowOrientationScreenSize0 = c(window).width()), 0 == b.windowOrientationScreenSize90 && 90 == window.orientation && (b.windowOrientationScreenSize90 = c(window).height()), 0 == b.windowOrientationScreenSize_90 && -90 == window.orientation && (b.windowOrientationScreenSize_90 = c(window).height()), b.windowOrientationScreenSize0 && 0 == window.orientation && c(window).width() > b.windowOrientationScreenSize0 && (doResizeNow = !1), b.windowOrientationScreenSize90 && 90 == window.orientation && c(window).height() > b.windowOrientationScreenSize90 && (doResizeNow = !1), b.windowOrientationScreenSize_90 && -90 == window.orientation && c(window).height() > b.windowOrientationScreenSize_90 && (doResizeNow = !1), 0 == d.windowWidth && (doResizeNow = !1, d.windowWidth = c(window).width())); - 1 != f && 9 == f && 0 == d.windowWidth && (doResizeNow = !1);
                ...
                b.responsive && doResizeNow && (!1 !== H && clearTimeout(H), H = setTimeout(function() {
                    M(d, b, t, v, a, l, g, e, k, q, r, B, z, s, x, n, y)
                }, 300))
            });
            c(z[d.current_img_no]).addClass("bottomNavButtonON");
            f = g.find("img:first");
            f[0].complete ? (c(".myloader", g).css("display", "none"), 0 < b.autoPlay && 1 < t && (b.showCircleTimer && (d.arcInitialTime = (new Date).getTime(), d.timeElapsed = 0, d.intervalID = setInterval(function() {
                G(d, b)
            }, 125)), d.timeoutID = setTimeout(function() {
                A(1, b, d, z, v, g, t, s, x)
            }, 1E3 * b.autoPlay))) : f.load(function() {
                c(".myloader", g).css("display", "none");
                0 < b.autoPlay && 1 < t && (b.showCircleTimer && (d.arcInitialTime = (new Date).getTime(), d.timeElapsed = 0, d.intervalID = setInterval(function() {
                    G(d, b)
                }, 125)), d.timeoutID = setTimeout(function() {
                    A(1, b, d, z, v, g, t, s, x)
                }, 1E3 * b.autoPlay))
